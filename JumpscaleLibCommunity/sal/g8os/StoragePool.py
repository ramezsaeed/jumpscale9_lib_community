from JumpscaleLib.sal.g8os.abstracts import Mountable
from JumpscaleLib.sal.g8os.abstracts import AYSable
import os
...
class StoragePool(Mountable):
    ...
    def ays(self):
        if self._ays is None:
            from JumpscaleLib.sal.g8os.atyourservice.StoragePool import StoragePoolAys
...
class FileSystem:
    ...
    def ays(self):
        if self._ays is None:
            from JumpscaleLib.sal.g8os.atyourservice.StoragePool import FileSystemAys
